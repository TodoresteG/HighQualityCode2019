namespace AirCombat.Entities.AirCrafts
{
    ...
    // TODO nothing done here. Maybe some bug fixes later in the document
    public abstract class AirCraft : IAirCraft
    {
        ...
        protected AirCraft(string model,double weight,decimal price, int attack,int defense,int hitPoints, IAssembler assembler)
        {
            this.Model = model;
            this.Weight = weight;
            this.Price = price;
