namespace AirCombat.Entities.Miscellaneous
{
    ...
    public class AircraftAssembler : IAssembler
    {
        ...
        // TODO: if the comments in the interface are correct -> Max have to be Sum.
        ...
        {
            this.IsPartNullValidation(arsenalPart);
        ...
        {
            this.IsPartNullValidation(shellPart);
        ...
        {
            this.IsPartNullValidation(endurancePart);

            this.enduranceParts.Add((IHitPointsModifyingPart)endurancePart);
        }

        private void IsPartNullValidation(IPart part) 
        {
            if (part == null)
            {
                throw new ArgumentNullException("Part cannot be null!");
            }
        }
    }
}