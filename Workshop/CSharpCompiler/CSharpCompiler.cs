namespace CSharpCompiler
{
    ...
    using global::CSharpCompiler.Exceptions;
    ...
    public class CSharpCompiler
    {
        ...
        private ICodeValidationStrategy validationStrategy;

        public CSharpCompiler(ICodeValidationStrategy validationStrategy)
        {
        ...
        {
            this.validationStrategy.Validate(codeString);
